...
public class PrecentageGraphFragment extends Fragment
{
    ...
    private PrecentageParameters mParameters;
     ...
     */
    public static PrecentageGraphFragment newInstance(PrecentageParameters parameters)
    {
        String json = JsonServiceYearTransactions.getInstance().toJson(parameters);
        PrecentageGraphFragment fragment = new PrecentageGraphFragment();
    ...
    /**
     */
    public PrecentageGraphFragment(){}
                             ...
                             Bundle savedInstanceState)
    {
        ...
        if (getArguments() != null)
        {
            ...
            mParameters = JsonServiceYearTransactions.getInstance().fromJsonToPrecentageParams(json);
     ...
     */
    public static class PrecentageParameters
    {
        ...
        public PrecentageParameters(String title)
        {
